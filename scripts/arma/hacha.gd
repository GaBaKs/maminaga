...
func aplicar_danio(objetivo: Node2D) -> void:
	if is_instance_valid(objetivo) and objetivo.has_method("recibir_danio_enemigo"):
		print("¡Hachazo de ", material_actual , " a: ", objetivo.name, "! Daño aplicado: ", danio)
